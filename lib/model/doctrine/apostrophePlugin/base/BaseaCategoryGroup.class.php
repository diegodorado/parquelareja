 ...
 * @method aCategoryGroup set()            Sets the current record's "category_id" value
 * @method aCategoryGroup set()            Sets the current record's "group_id" value
 * @method aCategoryGroup set()            Sets the current record's "Category" value
 * @method aCategoryGroup set()            Sets the current record's "Group" value
 * 
 * @package    symfony
 * @subpackage model
